...
const MobileNav = ({ showNav, closeNav }: Props) => {
  ...
  return (
    <div>
      ...
      {/* Nav Links */}
      <div className={`text-white fixed ${navOpen} justify-center flex flex-col h-full transform transition-all duration-500 delay-300 w-[88%] sm:w-[60] bg-black space-y-6 z-[100050] right-0`}>
        {NAV_LINKS.map((link) => {
